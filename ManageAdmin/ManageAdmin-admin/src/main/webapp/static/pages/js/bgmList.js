var deleteBgm = function(bgmId) {
	...
	$.ajax({
		url: $("#hdnContextPath").val() + '/video/deleteBgm.action?bgmId=' + bgmId,
		type: "POST",
...
var BgmList = function() {
    ...
    var handleBgmList = function() {
        ...
        jqGrid.jqGrid({  
            ...
            colModel: [  
                ...
                { name: 'path', index: 'path', width: 50, 
                	formatter: function(cellvalue, option, rowObject){
                		//formatter对这一列进行自定义操作，将获取到地址加上发布虚拟路径，可以点击试听
                        //cellvalue 这一列的值， option 表格相关操作，没用，rowObject 行对象
            ...
            rownumWidth: 30, 			// 如果rownumbers为true，则可以设置行号 的宽度
