...
<body class="login">
        ...
        <div class="content">
            ...
            <form class="login-form">
                ...
                <p>
                    <a href="<%=request.getContextPath()%>/users/login.action" class="btn-primary btn" id="register-btn">返回登录</a>
                </p>
                </div>
            </form>
            <!-- END LOGIN FORM -->
...
<![endif]-->
        ...
        <script src="<%=request.getContextPath() %>/static/pages/js/register.js?v=1.1" type="text/javascript"></script>
