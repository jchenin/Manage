...
<!-- <input type="hidden" id="apiServer" name="apiServer" value="http://192.168.1.105:8081"/>
<input type="hidden" id="bgmServer" name="bgmServer" value="http://192.168.1.105:8080/mvc-bgm"/>-->
<input type="hidden" id="apiServer" name="apiServer" value="https://www.wyh21.cn/videos"/>
<input type="hidden" id="bgmServer" name="bgmServer" value="http://49.234.207.183/mvc"/>
